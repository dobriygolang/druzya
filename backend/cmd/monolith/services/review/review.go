...
func NewReview(d monolithServices.Deps, slotBookings slotDomain.BookingRepo) *monolithServices.Module {
	if d.Log == nil {
	...
	transcoder := monolithServices.MustTranscode("review", connectPath, connectHandler)
