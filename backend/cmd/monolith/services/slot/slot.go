...
func NewSlot(d monolithServices.Deps) (*monolithServices.Module, slotDomain.BookingRepo) {
	if d.Log == nil {
	...
	list := &slotApp.ListSlots{Slots: pg, Reviews: reviewServices.SlotInterviewerStatsAdapter{}}
	...
	myBookings := &slotApp.ListMyBookings{Bookings: pg, HasReview: reviewServices.SlotBookingHasReviewAdapter{}}
	hostedBookings := &slotApp.ListHostedBookings{Bookings: pg, HasReview: reviewServices.SlotBookingHasReviewAdapter{}}
	...
	transcoder := monolithServices.MustTranscode("slot", connectPath, connectHandler)
