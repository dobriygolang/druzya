...
const (
	...
	// SectionEnglishHR is used only by ai_mock for English HR-rounds;
	// engineering-only tables (ratings, elo_snapshots, tasks,
	// arena_matches, slots) reject this value at the CHECK-constraint
	// layer, see migrations/00001_baseline.sql.
	SectionEnglishHR Section = "english_hr"
	// SectionSystemDesignSenior covers free-form architectural
	// discussion (distributed / real-time / ML /
	...
	// SectionTechLeadEM covers free-form STAR-style behavioral rounds
	// at Tech Lead / Engineering Manager
	...
	// SectionSysanalyst is a free-form interview round для системного
	// аналитика — requirements
	...
	// SectionProductAnalyst — product analyst track. Metrics
	...
	// SectionQA — QA / тестировщик free-form interview: test design,
	// API testing, automation, bug
	// analysis, process. Same gating as Sysanalyst — non-engineering,
	// non-task-based.
	SectionQA Section = "qa"
	// SectionDevOps — DevOps / SRE free-form interview:
	// infra, observability, CI/CD, incident response, security.
	SectionDevOps Section = "devops"
	// SectionMLEng — ML engineering free-form interview
	...
	// SectionDE — data engineering free-form interview под senior DE-роли: ETL/ELT
	...
	// SectionMLSystemDesign — granular ML system design stage
	// separately from generic ml_eng — для
	...
	// SectionMLCoding — hands-on Python+numpy/pandas/scikit
	...
	// SectionMLTheory — quiz-style deep learning fundamentals
