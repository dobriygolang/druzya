...
Схема ответа:
{
  ...
  "strengths": [<3-5 коротких bullet'ов in the user's preferred language: strengths>],
  "weaknesses": [<3-5 коротких bullet'ов in the user's preferred language: what to improve>],
  "suggested_lines": [<до 10 целых чисел: 1-based номера строк кода, которые стоит пересмотреть>],
  "rubric_md": "<2-4 предложения in the user's preferred language: overall verdict + 1-2 priority next steps>"
}
