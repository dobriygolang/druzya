...
--
-- channel: 'social' | 'match' | 'cohort' | 'system' | 'challenges' | 'wins'
-- type: short identifier (challenge|win|friend_added|cohort_war_started…)
...
-- channel_enabled: JSONB вида {"social":true,"match":true,"cohort":false,...}
