...
-- ============================================================
-- 00003 content: companies, tasks, test_cases, templates, follow-ups
--   + full seed catalogue (5 companies, 50 tasks, test cases,
--     templates, follow-up questions).
-- Consolidated from: 00003_content + 00009_seed_content (fake
-- podcast seed omitted — 00039 deleted them as fake data).
-- ============================================================
...
-- NB: legacy 00009 also seeded 12 fake podcasts here. They were dropped
-- by 00039 (fake URLs → 404); podcasts table is created & seeded (empty)
-- in 00008_social_ops.sql.
-- ============================================================
-- (podcast seed block removed)
-- ============================================================
