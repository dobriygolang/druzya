...
export default function HeroCardsPage() {
  ...
  return (
    <AppShellV2>
      <ComingSoon
        title="Hero Cards в разработке"
        description={
          'Коллекционные карточки игроков с редкостями, паками и обменом — ' +
          'отдельный домен, который мы делаем после Season Pass. ' +
          'Пока приходи в Сезон-пасс за наградами.'
        }
        primaryCta={{ label: 'Сезон-пасс', onClick: () => navigate('/season') }}
