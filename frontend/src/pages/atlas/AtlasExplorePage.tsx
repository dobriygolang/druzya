// /atlas/explore — legacy skill-graph (PoE-style). Был основной страницей
// /atlas до Phase 2e; теперь живёт под /atlas/explore как «Explore Mode»,
// а главный /atlas — Tracks ribbon (AtlasPage.tsx).
//
// WAVE-11 split (AtlasCanvasLegacy / AtlasV2Surface / AtlasDrawer /
// AtlasFilters / AtlasListMode) сохранён.
