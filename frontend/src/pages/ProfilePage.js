...
function AchievementsCard({ profile }) {
    ...
    return (_jsxs(Card, { className: "flex-col gap-3 p-5", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h3", { className: "font-display text-base font-bold text-text-primary", children: t('achievements_title') }), _jsxs("span", { className: "font-mono text-[11px] text-text-muted", children: [earned, " / 120"] })] }), _jsx("div", { className: "grid grid-cols-3 gap-2", children: BADGES.map((b) => {
                    const Icon = b.icon;
                    return (_jsxs("div", { className: cn('flex aspect-square flex-col items-center justify-center gap-1 rounded-lg bg-gradient-to-br p-2', b.gradient), children: [_jsx(Icon, { className: "h-5 w-5 text-white" }), _jsx("span", { className: "font-mono text-[10px] font-semibold text-white", children: b.label })] }, b.label));
                }) })] }));
}
...
export default function ProfilePage() {
    ...
    if (!vm)
        return _jsx(ProfileSkeleton, {});
    return (_jsxs(AppShellV2, { children: [_jsx(Hero, { vm: vm }), _jsx(ProfileTabBar, { tab: tab, setTab: setTab }), _jsxs("div", { className: "flex flex-col gap-6 px-4 py-6 sm:px-8 lg:flex-row lg:px-10 lg:py-8", children: [_jsxs("div", { className: "flex w-full shrink-0 flex-col gap-5 lg:w-[380px]", children: [_jsx(SkillsCard, {}), isOwn && _jsx(AchievementsCard, { profile: ownQuery.data }), _jsx(GuildCard, {})] }), _jsx("div", { className: "flex min-w-0 flex-1 flex-col", children: _jsx(Leaderboard, {}) })] })] }));
}
