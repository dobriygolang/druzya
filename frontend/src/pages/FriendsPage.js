...
function FriendCard({ f, onChallenge, onChat, onUnfriend, }) {
    ...
    return (_jsxs(Card, { className: "flex-col gap-3 p-5", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx(Avatar, { size: "lg", gradient: hashGradient(f.user_id), initials: initial }), _jsxs("div", { className: "flex flex-1 flex-col gap-0.5", children: [_jsxs("span", { className: "font-display text-sm font-bold text-text-primary", children: ["@", f.username] }), _jsx("span", { className: "font-mono text-[11px] text-text-muted", children: tier })] })] }), _jsx("span", { className: "inline-flex w-fit items-center rounded-full bg-surface-2 px-2.5 py-1 font-mono text-[10px] font-semibold text-text-muted", children: status }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { size: "sm", variant: "primary", icon: _jsx(Swords, { className: "h-3.5 w-3.5" }), className: "flex-1", onClick: onChallenge, children: t('friends.challenge') }), _jsx(Button, { size: "sm", variant: "ghost", icon: _jsx(MessageSquare, { className: "h-3.5 w-3.5" }), className: "flex-1", onClick: onChat, title: t('friends.chat_wip', 'Скоро'), children: t('friends.chat') }), _jsx("button", { type: "button", onClick: onUnfriend, className: "grid h-8 w-8 place-items-center rounded-md bg-danger/10 text-danger hover:bg-danger/25", title: t('friends.unfriend', 'Удалить из друзей'), children: _jsx(UserMinus, { className: "h-4 w-4" }) })] })] }));
}
