...
const EDITOR_THEMES: Record<EditorThemeName, EditorThemeBundle> = {
  black: {
    highlight: HighlightStyle.define([
      ...
      { tag: [t.typeName, t.className, t.namespace, t.angleBracket], color: '#56b6c2' },
      { tag: [t.string, t.special(t.string), t.character], color: '#e5c07b' },
      { tag: t.escape, color: '#56b6c2' },
      { tag: t.regexp, color: '#e06c75' },
      { tag: [t.number, t.atom], color: '#d19a66' },
      { tag: t.bool, color: '#d19a66' },
      { tag: t.null, color: '#d19a66' },
      { tag: t.literal, color: '#d19a66' },
      { tag: [t.constant(t.variableName), t.constant(t.propertyName)], color: '#d19a66' },
      ...
      { tag: [t.standard(t.variableName), t.special(t.variableName), t.self], color: '#c678dd' },
      { tag: t.operator, color: '#abb2bf' },
      { tag: t.punctuation, color: '#abb2bf' },
      { tag: t.bracket, color: '#abb2bf' },
      { tag: t.tagName, color: '#e06c75' },
      { tag: t.attributeName, color: '#d19a66' },
      { tag: t.heading, color: '#e5e5e5', fontWeight: 'bold' },
  ...
  vscode: {
    highlight: HighlightStyle.define([
      ...
      { tag: t.heading, color: '#9cdcfe', fontWeight: 'bold' },
  ...
  'yandex-code': {
    highlight: HighlightStyle.define([
      ...
      { tag: [t.typeName, t.className, t.namespace, t.angleBracket], color: '#00627a' },
      { tag: [t.string, t.special(t.string), t.character], color: '#067d17' },
      { tag: t.escape, color: '#067d17' },
      { tag: t.regexp, color: '#067d17' },
      { tag: [t.number, t.atom], color: '#1750eb' },
      { tag: t.bool, color: '#0033b3' },
      { tag: t.null, color: '#0033b3' },
      { tag: t.literal, color: '#1750eb' },
      { tag: [t.constant(t.variableName), t.constant(t.propertyName)], color: '#871094' },
      ...
      { tag: [t.function(t.variableName), t.function(t.propertyName), t.labelName], color: '#00627a' },
      { tag: t.macroName, color: '#871094' },
      { tag: [t.variableName, t.propertyName], color: '#080808' },
      { tag: [t.standard(t.variableName), t.special(t.variableName), t.self], color: '#0033b3' },
      ...
      { tag: t.heading, color: '#080808', fontWeight: 'bold' },
  ...
  'code-interview': {
    highlight: HighlightStyle.define([
      ...
      { tag: [t.typeName, t.className, t.namespace, t.angleBracket], color: '#8be9fd' },
      { tag: [t.string, t.special(t.string), t.character], color: '#f1fa8c' },
      { tag: t.escape, color: '#ffb86c' },
      { tag: t.regexp, color: '#ff5555' },
      { tag: [t.number, t.atom], color: '#bd93f9' },
      { tag: t.bool, color: '#bd93f9' },
      { tag: t.null, color: '#bd93f9' },
      { tag: t.literal, color: '#bd93f9' },
      { tag: [t.constant(t.variableName), t.constant(t.propertyName)], color: '#bd93f9' },
      ...
      { tag: [t.function(t.variableName), t.function(t.propertyName), t.labelName], color: '#50fa7b' },
      { tag: t.macroName, color: '#ff79c6' },
      { tag: [t.variableName, t.propertyName], color: '#f8f8f2' },
      { tag: [t.standard(t.variableName), t.special(t.variableName), t.self], color: '#ff79c6' },
      ...
      { tag: t.heading, color: '#f8f8f2', fontWeight: 'bold' },
