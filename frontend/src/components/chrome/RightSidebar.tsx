  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          {/* Bible §3.1 — flasks are CONSUMABLE buffs (not duplicate stats).
              Charges refill on completed dailies; pop one before a hard mock to
              get a temporary boost. Until backend wires `flask_charges`, we
              render decorative levels and a numeric charge badge under each. */}
          <PowerFlask color="#6a9fd4" fill={0.85} charges={3} label="INSIGHT" />
          <PowerFlask color="#c22222" fill={0.55} charges={2} label="RESOLVE" />
          <PowerFlask color="#1d9e75" fill={0.92} charges={4} label="ICHOR" />
          <PowerFlask color="#c8a96e" fill={0.3} charges={1} label="VIGOR" />
        </div>
      </div>
