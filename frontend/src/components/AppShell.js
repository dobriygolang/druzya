...
function UserMenu({ onClose }) {
    ...
    const adminStatus = admin.error?.status;
...
function SessionExpiredToast() {
    ...
    useEffect(() => {
        ...
        window.addEventListener('druz9:session-expired', onExpired);
        return () => window.removeEventListener('druz9:session-expired', onExpired);
    }, []);
    if (!visible)
        return null;
    return (_jsx("div", { role: "status", className: "fixed left-1/2 top-4 z-[60] -translate-x-1/2 rounded-lg border border-warn/60 bg-surface-1 px-4 py-2 text-sm text-text-primary shadow-card", children: "\u0421\u0435\u0441\u0441\u0438\u044F \u0438\u0441\u0442\u0435\u043A\u043B\u0430, \u043F\u0435\u0440\u0435\u0430\u0432\u0442\u043E\u0440\u0438\u0437\u0443\u0439\u0442\u0435\u0441\u044C." }));
}
export function AppShellV2({ children }) {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-bg text-text-primary", children: [_jsx(TopNav, {}), _jsx(SessionExpiredToast, {}), _jsx(AnimatePresence, { mode: "wait", children: _jsx(motion.main, { ...motionProps, children: children }, location.pathname) })] }));
}
