...
const items: NotificationItem[] = [
  ...
  { id: 'n4', kind: 'guild', unread: true, title: 'Война гильдий: Ironclad ведёт 2 140 — 1 670', subtitle: 'твой вклад: 240 очков · финал через 2д 4ч', time: '5 ч', bucket: 'today' },
...
export const notificationsHandlers = [
  http.get(`${base}/notifications`, () =>
    HttpResponse.json({
      unread: 12,
      total: 47,
      filters: { challenges: 4, wins: 9, requests: 3, guild: 9, system: 12 },
      tabs: { all: 47, unread: 12, social: 8, match: 18, guild: 9, system: 12 },
      items,
    }),
  ),
]
