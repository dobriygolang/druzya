...
export const nativeHandlers = [
    http.get(`${base}/native/session/:id/score`, ({ params }) => HttpResponse.json({ ...score, session_id: params.id })),
    http.get(`${base}/native/session/:id/provenance`, ({ params }) => HttpResponse.json({ ...provenance, session_id: params.id })),
];
