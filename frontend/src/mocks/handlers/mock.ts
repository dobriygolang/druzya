...
export const mockHandlers = [
  ...
  http.post(`${base}/mock/session/:id/finish`, () =>
    HttpResponse.json({ ...session, status: 'finished', finished_at: new Date().toISOString() }),
  ),

  http.get(`${base}/mock/session/:id/report`, ({ params }) =>
    HttpResponse.json({
