...
export const dailyHandlers = [
  ...
  http.post(`${base}/daily/kata/submit`, () =>
    HttpResponse.json({ passed: true, tests_passed: 5, tests_total: 5, xp_earned: 30, streak }),
  ),
  ...
  http.get(`${base}/daily/autopsy/:id`, ({ params }) =>
    HttpResponse.json({
      id: params.id,
      status: 'ready',
      outcome: 'rejection',
