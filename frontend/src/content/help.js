...
import { Rocket, Swords, Shield, Crown, Sparkles, Lock, MessageCircle, Mail, Send, Code as Github, } from 'lucide-react';
import { createElement } from 'react';
const ic = (Comp, cls = 'h-5 w-5') => createElement(Comp, { className: cls });
...
export const HELP_FAQ = [
    ...
    },
    {
        ...
        answer: 'Premium даёт безлимит mock-интервью с моделью GPT-4o (вместо free GPT-4o-mini), премиальные TTS-голоса для разбора, расширенную аналитику в weekly-report и эксклюзивные бейджи. Цена 490₽/мес или 4900₽/год. Оплата через Boosty, отмена в любой момент.',
    },
    {
        id: 'guild-create',
        question: 'Как создать гильдию?',
        tags: ['Гильдии'],
        answer: 'Создание гильдии откроется после достижения 1500 ELO в любой из секций (algorithms / SQL / etc). Стоимость регистрации — 5000 XP. Гильдия имеет до 30 участников, своё название и эмблему. Раз в неделю — guild war против другой гильдии того же тира.',
    },
    {
        id: 'ai-models',
        question: 'Какие AI модели доступны?',
        tags: ['AI', 'OpenRouter'],
        answer: 'Бесплатно: GPT-4o-mini для mock-интервью + браузерный TTS. Premium: GPT-4o + Edge TTS Premium голос. Модель и провайдер можно поменять в Настройках → AI.',
    },
    {
        id: 'streak-freeze',
        question: 'Как работает Streak Freeze?',
        tags: ['Daily', 'Стрик'],
        answer: 'Freeze автоматически защищает streak если ты пропустил день. Каждые 7 дней непрерывного решения daily-kata получаешь 1 freeze (максимум 3). Дополнительные можно купить за 100 💎.',
    },
    {
        id: 'refund',
        question: 'Возврат денег за подписку',
        tags: ['Биллинг'],
        answer: 'Если подписка была активна меньше 14 дней — возврат полной суммы по запросу в support@druz9.online или через @druz9_support в Telegram. После 14 дней возврат не предусмотрен, но подписка работает до конца оплаченного периода после отмены.',
    },
];
