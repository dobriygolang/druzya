 ...
 */
export class GuildMember extends Message {
    /**
    ...
    static typeName = "druz9.v1.GuildMember";
 ...
 */
export class Guild extends Message {
    /**
    ...
    static runtime = proto3;
    static typeName = "druz9.v1.Guild";
    static fields = proto3.util.newFieldList(() => [
 ...
 */
export class GuildSummary extends Message {
    /**
     * @generated from field: string id = 1;
     */
    id = "";
    ...
    static runtime = proto3;
    static typeName = "druz9.v1.GuildSummary";
    static fields = proto3.util.newFieldList(() => [
        { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 3, name: "emblem", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 */
export class GuildWar extends Message {
    /**
     * @generated from field: string id = 1;
     */
    id = "";
    ...
    static runtime = proto3;
    static typeName = "druz9.v1.GuildWar";
    static fields = proto3.util.newFieldList(() => [
        { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 */
export class GetMyGuildRequest extends Message {
    constructor(data) {
        super();
        proto3.util.initPartial(data, this);
    }
    static runtime = proto3;
    static typeName = "druz9.v1.GetMyGuildRequest";
    static fields = proto3.util.newFieldList(() => []);
    static fromBinary(bytes, options) {
 ...
 */
export class GetGuildRequest extends Message {
    /**
    ...
    static runtime = proto3;
    static typeName = "druz9.v1.GetGuildRequest";
    static fields = proto3.util.newFieldList(() => [
 ...
 */
export class GetGuildWarRequest extends Message {
    /**
     * @generated from field: string guild_id = 1;
     */
    guildId = "";
    ...
    static runtime = proto3;
    static typeName = "druz9.v1.GetGuildWarRequest";
    static fields = proto3.util.newFieldList(() => [
        { no: 1, name: "guild_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    ]);
    static fromBinary(bytes, options) {
 ...
 */
export class TopGuildSummary extends Message {
    /**
     * @generated from field: string guild_id = 1;
     */
    guildId = "";
    ...
    static runtime = proto3;
    static typeName = "druz9.v1.TopGuildSummary";
    static fields = proto3.util.newFieldList(() => [
        { no: 1, name: "guild_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 2, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
        { no: 3, name: "emblem", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 */
export class ListTopGuildsRequest extends Message {
    /**
    ...
    static runtime = proto3;
    static typeName = "druz9.v1.ListTopGuildsRequest";
    static fields = proto3.util.newFieldList(() => [
 ...
 */
export class ListTopGuildsResponse extends Message {
    /**
    ...
    static runtime = proto3;
    static typeName = "druz9.v1.ListTopGuildsResponse";
    static fields = proto3.util.newFieldList(() => [
