...
// cue/node_modules is installed), it walks up from the frontend file
// and never finds @bufbuild/protobuf — the package physically sits in
// cue/node_modules. Two complementary fixes land here:
//
//   1. Explicit alias for each peer — points the module specifier at
//      cue/node_modules regardless of which file imported it.
...
//      cue/ have their own node_modules at dev-time.
const PEER_ALIASES = {
