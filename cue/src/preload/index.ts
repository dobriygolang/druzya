...
const api: Druz9API = {
  ...
  hotkeys: {
    ...
    setOverride: (action, accelerator) =>
      ipcRenderer.invoke(invokeChannels.hotkeysSetOverride, {
        action,
        accelerator,
      }) as ReturnType<Druz9API['hotkeys']['setOverride']>,
    listOverrides: () =>
      ipcRenderer.invoke(invokeChannels.hotkeysListOverrides) as ReturnType<
        Druz9API['hotkeys']['listOverrides']
      >,
  },
  windows: {
