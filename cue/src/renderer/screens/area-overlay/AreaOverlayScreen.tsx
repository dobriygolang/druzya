...
export function AreaOverlayScreen() {
  ...
  return (
    ...
    >
      {/* Dimmed backdrop — pure black (b/w rule), was oklch with 0.01 chroma
          on 280° (slight blue tint). */}
      <div
        style={{
          position: 'absolute',
          inset: 0,
      ...
      {rect && (
        ...
        >
          {/* Capture confirmation dot — 4×4px white in NE corner of selection.
              Subtle visual cue that the area is "armed" / captured.
              200ms fade-in via CSS animation. */}
          <span
            aria-hidden="true"
            style={{
              position: 'absolute',
              ...
              width: 4,
              height: 4,
              background: 'var(--d9-ink, #fff)',
              borderRadius: 0,
              opacity: 0,
              animation: 'd9-fade-in 200ms ease-out forwards',
            }}
          />
      ...
      >
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
          {/* v2: live-capture signal — canonical red dot (was white-glow). */}
          <span
            aria-hidden="true"
            className="red-pulse"
            style={{
