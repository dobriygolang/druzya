/**
 * Cue Input + Textarea — foundation primitive (visual-language v2).
 *
 ...
 *      border-bottom: 1px solid var(--d9-hairline-b); padding-bottom: 8px;
 *      background: transparent; outline: none;
 *      focus: border-bottom-color var(--d9-ink); border-bottom-width 1.5px
 ...
 *      1.5×24px red signal stripe before the label (--d9-accent).
 ...
 *  - Tokens: var(--d9-hairline-b), var(--d9-ink), var(--d9-ink-dim),
 *      var(--d9-accent), var(--motion-dur-small), var(--motion-ease-standard).
 *
 * If you edit Hone Input, edit this one too (tokens differ — palette only).
 */
...
const COLOR_INK = 'var(--d9-ink)';
const COLOR_INK_DIM = 'var(--d9-ink-dim)';
const COLOR_HAIRLINE = 'var(--d9-hairline-b)';
const COLOR_RED = 'var(--d9-accent)';
