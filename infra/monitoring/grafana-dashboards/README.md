...
If you switch off Grafana Cloud, drop the files in `/etc/grafana/provisioning/dashboards/` and configure a `dashboards-provider.yml` block pointing at this folder.
