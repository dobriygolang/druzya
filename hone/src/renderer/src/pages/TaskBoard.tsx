...
const COLUMNS: ReadonlyArray<ColumnDef> = [
  ...
  { status: 'in_progress', label: 'In Progress', accent: '#fb923c' },
  { status: 'in_review', label: 'In Review', accent: '#38bdf8' },
  { status: 'done', label: 'Done', accent: '#4ade80' },
  { status: 'dismissed', label: 'Dismissed', accent: '#6b6b78' },
];
