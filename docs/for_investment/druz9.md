# druz9.online — AI-coach + AI-mock + atlas

Веб-продукт экосистемы. Сайт, на котором разработчик готовится к собесу, растёт по треку и видит свой прогресс — не курсы, не учебник, а **AI-coach с памятью + AI-mock с 5-axis radar + curated atlas + tutor toolkit**.
