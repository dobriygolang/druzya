...
## Implementation status (2026-05-12 marathon)

Identity claim полностью реализован end-to-end. Идентификатор реализации — DB v95 (marathon migrations 00083-00096, full list в [../tech/backend.md](../tech/backend.md)).
