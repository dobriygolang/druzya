...
См [identity.md](./identity.md). Короткий план 2 недели:
1. Drop marketplace (1 день)
2. ML eng track (2 дня)
3. English tutor↔student polish (2 дня)
4. Cleanup сервисов: tg_coach + feed + clubs (1 день)
