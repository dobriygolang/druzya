...
druz9 — **Strava для разработчиков**: PvP-платформа с подготовкой к собеседованиям, гильдиями, командной игрой и AI-инструментами. Цель — занять нишу "соревновательного программирования + карьерного развития" между LeetCode (одинокая практика) и Discord (соц-без структуры).
...
### Q4
- Гильдии + War Room (командные войны)
...
- Discord-style голосовые комнаты для гильдий
...
|---|---|---|---|
| LeetCode/HackerRank выпустят PvP | Med | High | First-mover в RU-сегменте, гильдии и viral-механики копировать сложно |
| Регуляторика на сбор кода/answers | Low-Med | Med | GDPR-by-design, всё анонимизируется, opt-in publish |
| Высокий churn после собеса (нашли работу — ушли) | High | Med | Гильдии = social glue, season pass = sunk-cost, mentoring = монетизация после трудоустройства |
